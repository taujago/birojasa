    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="hidden" name="id_model" id="id_model" value="<?php echo $id_model; ?>"></input>
        <input type="text" name="model" id="model" class="form-control input-style" value="<?php echo $model; ?>">
      </div>
    </div>
