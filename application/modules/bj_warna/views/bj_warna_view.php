    ...
    <script src="<?php echo base_url("assets") ?>/js/bootstrap-datepicker.js"></script>
     <script src="<?php echo base_url("assets") ?>/js/jquery.dataTables.min.js"></script>           
              <div class="x_title">
                  <h2>Data Samsat <small>Samsat </small></h2>
          ...
          <form role="form" action="" id="btn-cari">
            <div class="col-md-3">
              ...
              <label for="nama">Nama </label>
                <input id="WARNA_NAMA" name="WARNA_NAMA" type="text" class="form-control" placeholder="Nama"></input>
              </div>
            </div>
            <div class="col-md-1">
              <div class="form-group">
...
<thead>
  <tr>
        ...
        <th width="23%" style='text-align:center;vertical-align:middle'>Warna</th>
