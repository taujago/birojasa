    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="hidden" name="id_jenis" id="id_jenis" value="<?php echo $id_jenis; ?>"></input>
        <input type="text" name="jenis" id="jenis" class="form-control input-style" value="<?php echo $jenis; ?>">
      </div>
    </div>
    ...
    <div class="form-group pull-center">
        <div class="col-sm-offset-3 col-sm-9">
          ...
          <a href="<?php echo site_url('sa_jenis'); ?>"><button style="border-radius: 0;" id="reset" type="button" class="btn btn-lg btn-danger">Cancel</button></a>
        </div>
      </div>
