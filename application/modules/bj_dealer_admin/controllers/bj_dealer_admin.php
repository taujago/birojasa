<?php 
class bj_dealer_admin extends biro_jasa_controller{
    var $controller;
    function bj_dealer_admin(){
        parent::__construct();
...
function index(){
        ...
        $this->set_subtitle("Dealer Admin");
        $this->set_title("Dealer Admin");
...
if($this->form_validation->run() == TRUE ) { 
    ...
    function get_data() {
      ...
      //  order[0][column]
        ...
        <a href ='bj_dealer_admin/editdata?id=$id' class='btn btn-primary btn-xs'><i class='fa fa-edit'></i>Edit</a>";
    ...
    function editdata(){
        ...
        $this->set_subtitle("Edit Admin Dealer");
        $this->set_title("Edit Admin Dealer");
        $this->set_content($content);
        $this->cetak();
