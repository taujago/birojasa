...
class bj_invoice_stnk_model extends CI_Model {


	function bj_invoice_stnk_model(){
		parent::__construct();
	}
 ...
 function get_data($param)
	{		
		...
		// exit;
		 ...
		 $kolom = array(0=>"id",
		 	...
		 	$this->db->where('stnk_serah_dealer', 0);	
	...
	function cekbiaya($id){
		$this->db->select('bayar_jumlah_stnk')->from("bj_bbn_satu");
		$this->db->where('id', $id);
