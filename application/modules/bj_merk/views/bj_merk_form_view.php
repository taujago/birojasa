...
<div class="panel panel-primary">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
      <input type="hidden" name="old_id" id="old_id" value="<?php echo isset($kode)?$kode:''; ?>">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        ...
        <input type="text" name="nama" id="nama" class="form-control input-style" placeholder="Merk . . ." value="<?php echo isset($nama)?$nama:""; ?>">
      </div>
    </div>
    ...
    <div class="form-group pull-center">
        <div class="col-sm-offset-3 col-sm-9">
          ...
          <a href="<?php echo site_url('bj_merk'); ?>"><button style="border-radius: 0;" id="reset" type="button" class="btn btn-lg btn-danger">Cancel</button></a>
        </div>
      </div>
