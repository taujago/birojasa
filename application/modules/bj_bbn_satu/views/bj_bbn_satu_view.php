                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">No. Rangka
                      </label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="no_faktur" name="no_mesin" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Tgl. Faktur 
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="faktur" class="date-picker form-control col-md-7 col-xs-12 tgl" required="required" type="text">
                      </div>
                    </div>
                    <div class="form-group">
