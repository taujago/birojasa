...
<div class="col-md-12">
	<button  type="button" class="btn btn-success col-md-4" id="cetak">Cetak Penyerahan Berkas</button> <a href="<?php echo site_url('us_serah_stnk_detail') ?>" class="btn btn-danger col-md-2">Kembali</a>
</div>
