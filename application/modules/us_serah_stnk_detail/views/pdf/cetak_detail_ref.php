...
<table width="100%">
  <tr>
    <td width="100%" align="center"><h1>Detail Penyerahan STNK Ke-Samsat <?php echo $data_ref['nm_samsat'] ?></h1></td>
  </tr>
   <tr>
...
<table border="0.4" cellpadding="5" width="100%">
  ...
  <tr>
    ...
    <td><?php echo rupiah($row['rp_daftar_stnk']); ?></td>
  </tr>
  <?php endforeach; ?>
