...
<table width="100%">
  <tr>
    ...
    <td width="60%"><b>Pembayaran Pembuatan STNK sebanyak <?php echo $data_inv['jumlah_berkas']; ?> Berkas dengan nomor STNK sebagai berikut : <?php foreach($new_data as $x => $row){ echo $row['stnk_no'].', '; } ?><?php echo $dll; ?> </b></td>
    <td width="15%">&nbsp;</td>
...
<table width="100%">
  ...
  <tr>
    ...
    <td width="5%"></td>
    <td width="15%" align="right"><?php echo rupiah($data_inv['kode_unik']); ?>,-</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Discount</td>
