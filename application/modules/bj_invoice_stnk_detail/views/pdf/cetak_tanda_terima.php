...
<table width="100%">
  <tr>
   ...
   <tr>
    <td width="100%" align="center"><h3><?php echo $data_inv['no_tt_stnk']; ?></h3></td>
  </tr>
...
<table width="100%">
  ...
  <tr>
    <td>Keterangan</td>
    <td>: <?php echo $data_inv['jumlah_berkas']; ?> Buah Buku STNK dengan Nomor STNK sbb : </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;&nbsp;<?php foreach($new_data as $x => $row){ echo $row['stnk_no'].', '; } ?><?php echo $dll; ?></td>
  </tr>
</table>
