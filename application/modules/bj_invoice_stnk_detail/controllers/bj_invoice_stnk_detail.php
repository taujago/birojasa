<?php 
class bj_invoice_stnk_detail extends biro_jasa_controller{
	var $controller;
	...
	function bj_invoice_stnk_detail(){
		...
		$this->load->model('bj_invoice_stnk_detail_model','dm');
	...
	function index(){
		...
		$this->set_subtitle("Invoice dan Tanda Terima STNK");
	...
	function get_data(){
      ...
      //  order[0][column]
        ...
        $no_invoice = $row['no_invoice'];
         ...
         $nama ="<b><a href='bj_invoice_stnk_detail/lihatdata?id=$id'>$no_invoice</a></b>";
    ...
    function lihatdata(){
		...
		$this->set_subtitle("Detail No. Invoice : ".$no_invoice_stnk);
		$this->set_title("STNK");
		$this->set_content($content);
		$this->cetak();
    ...
    function pdf(){
    	...
    	$this->db->select('s.*, d.nama as nm_dealer')->from("invoice_stnk s");
