    ...
    <script type="text/javascript" src="<?php echo base_url();?>assets/js/autoNumeric.js"></script>
     ...
     <form role="form" action="" id="btn-cari">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label>&nbsp;</label>
                <input id="in_mesin" name="in_mesin" type="text" class="form-control input-style" placeholder="Input No. Rangka/Mesin" />
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
...
<div class="panel panel-primary ">
    ...
    <br />&nbsp;
    <div class="form-group">
      <label class="col-sm-3 control-label">Tanggal STNK</label>
      <div class="col-sm-9">
        <input type="text" name="stnk_tgl" id="stnk_tgl" class="tanggal datepicker form-control input-style" placeholder="Isi Tgl. STNK . . ." data-date-format="dd-mm-yyyy">
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-3 control-label">No. STNK</label>
      <div class="col-sm-9">
        <input type="text" name="stnk_no" id="stnk_no" class="form-control input-style" placeholder="Isi No. STNK . . .">
      </div>
    </div>
