<?php 
class us_penyerahan_notis extends user_controller{
    var $controller;
    
    
    function us_penyerahan_notis(){
        parent::__construct();

        $this->controller = get_class($this);
        $this->load->model('us_penyerahan_notis_model','dm');
    ...
    function index(){
        ...
        $this->set_subtitle("Detail Penyerahan Notis Ke-Samsat");
        $this->set_title("STNK");
    ...
    function get_data(){
      ...
      //  order[0][column]
        ...
        $no_ref = $row['no_ref'];
         ...
         $nama ="<b><a href='us_penyerahan_notis/lihatdata?id=$id'>$no_ref</a></b>";
