...
<div class="panel panel-primary ">
    ...
    <br /> &nbsp;
      <div class="form-group">
      <label class="col-sm-3 control-label">Bayar STCK</label>
      <div class="col-sm-9">
        <input type="text" name="jumlah_bayar_stck" id="jumlah_bayar_stck" class="rupiah form-control input-style" placeholder="Input Biaya STCK . . ." data-a-sign="" data-a-dec="," data-a-sep=".">
      </div>
    </div>
