          ...
          <form role="form" action="" id="btn-cari">
            <div class="col-md-3">
              ...
              <label for="nama">Jenis </label>
                <input id="nm_jenis" name="nm_jenis" type="text" class="form-control" placeholder="Jenis"></input>
              </div>
            </div>
            <div class="col-md-1">
              <div class="form-group">
...
<thead>
  <tr>
        ...
        <th width="23%" style='text-align:center;vertical-align:middle'>Jenis</th>
