...
<div class="panel panel-primary ">
    ...
    <br /> &nbsp;
      <div class="form-group">
      <label class="col-sm-3 control-label">Biaya Notis</label>
      <div class="col-sm-9">
        <input type="text" name="bayar_jumlah_stnk" id="bayar_jumlah_stnk" class="rupiah form-control input-style" placeholder="Input Biaya Notis . . ." data-a-sign="" data-a-dec="," data-a-sep=".">
      </div>
    </div>
