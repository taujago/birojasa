<?php
class us_terima_bpkb_detail extends user_controller{
	var $controller;
    
    
	function us_terima_bpkb_detail(){
		parent::__construct();

		$this->controller = get_class($this);
		$this->load->model('us_terima_bpkb_detail_model','dm');
	...
	function index(){
		...
		$this->set_subtitle("Detail Penerimaan BPKB Polda");
		$this->set_title("BPKB");
    ...
    $tanggal_akhir = $post['tanggal_akhir'];
            ...
            $this->db->where('s.pengurus_bpkb', $pengguna);       
