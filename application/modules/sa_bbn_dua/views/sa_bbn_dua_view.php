        ...
        <!-- Content Header (Page header) -->
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Data Estimasi BBN2</h3>
              <div class="box-tools pull-right">
              <a href="<?php echo site_url("$this->controller/baru"); ?>"><button type="button" class="btn btn-primary form-control"><i class="fa fa fa-plus-circle "></i> Tambah BBN 2</button></a>
              </div>
            </div>
            <div class="box-body">
...
<?php 
$this->load->view("sa_bbn_dua_view_js");
?>