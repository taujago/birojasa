    ...
    <script src="<?php echo base_url("assets") ?>/js/bootstrap-datepicker.js"></script>
     <script src="<?php echo base_url("assets") ?>/js/jquery.dataTables.min.js"></script>           
              <div class="x_title">
                  <h2>Data Type <small>Jenis </small></h2>
          ...
          <form role="form" action="" id="btn-cari">
            <div class="col-md-3">
              ...
              <label for="nama">Type </label>
                <input id="tipe" name="tipe" type="text" class="form-control" placeholder="Type"></input>
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
                <label>Merk</label>
                <?php echo form_dropdown("merk",$arr_merek,'','id="merk" class="form-control"'); ?>
              </div>
            </div>
            <div class="col-md-1">
              <div class="form-group">
...
<thead>
  <tr>
        ...
        <th width="23%" height="50" style='text-align:center;vertical-align:middle'>Type</th>
