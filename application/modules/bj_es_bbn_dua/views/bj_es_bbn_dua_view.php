    ...
    <script src="<?php echo base_url("assets") ?>/js/bootstrap-datepicker.js"></script>
     <script src="<?php echo base_url("assets") ?>/js/jquery.dataTables.min.js"></script>           
              <div class="x_title">
                  <h2>Data <small>Biaya Estimasi BBN 2 </small></h2>
...
<table width="100%" border="0" id="bbn_dua" class="table table-striped 
             table-bordered table-hover dataTable no-footer" role="grid" style='text-align:center;vertical-align:middle'>

<thead>
  <tr> 
        <th width="5%" height="50px" style='text-align:center;vertical-align:middle'>#</th>
        <th width="20%" style='text-align:center;vertical-align:middle'>Tipe Kendaraan</th>
        <th width="10%" style='text-align:center;vertical-align:middle'>Tahun</th>
        <th width="20%" style='text-align:center;vertical-align:middle'>Jenis Perubahan</th>
        ...
        <th width="15%" style='text-align:center;vertical-align:middle'>Action</th>
    </tr>
