    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="no_siup" id="no_siup" class="form-control input-style" placeholder="Nomor Siup . . .">
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-3 control-label">NO. NPWP</label>
      <div class="col-sm-9">
        <input type="text" name="no_npwp" id="no_npwp" class="form-control input-style" placeholder="NO. NPWP . . .">
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-3 control-label">No. TDP</label>
      <div class="col-sm-9">
        <input type="text" name="no_tdp" id="no_tdp" class="form-control input-style" placeholder="No. TDP">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="telp" id="telp" class="form-control input-style" placeholder="No. Telp">
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-3 control-label">No. HP</label>
      <div class="col-sm-9">
        <input type="text" name="hp" id="hp" class="form-control input-style" placeholder="No. HP . .">
      </div>
    </div>
    <div class="form-group">
