    ...
    var dt = $("#us_serah_bpkb_detail").DataTable(
            {
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '<?php echo site_url("us_serah_bpkb_detail/get_data") ?>'
            });
...
$("#cetak").click(function() {
  ...
  open('<?php echo site_url("$this->controller/pdf_ref?"); ?>'+'tanggal_awal='+ tanggal_awal +'&tanggal_akhir='+tanggal_akhir+'&pol='+ pol);
