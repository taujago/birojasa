          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                 <a href="<?php echo site_url("$this->controller/baru"); ?>"><button type="button" class="btn btn-primary form-control"><i class="fa fa fa-plus-circle "></i> Tambah Merk</button></a>
              </div>
            </div>
            <div class="box-body">
...
<table width="100%" border="0" id="tbl_merk" class="table table-striped 
...
<?php 
$this->load->view("sa_merk_view_js");
?>